    ...
    class Program
    {
        ...
        static void TampilPenjualan()
        {
            ...
            foreach (Penjualan penjualan in daftarPenjualan)
            {
                ...
                else if (penjualan.Jenis == 'C' || penjualan.Jenis == 'c')
                {
                    Console.WriteLine("{0}, {1}, {2}, {3}, Credit, {4}", no, penjualan.Nota, penjualan.Tanggal, penjualan.Nama, penjualan.Total);
                }
